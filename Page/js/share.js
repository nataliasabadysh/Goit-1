...
!(function(c, g, b, h) {
  c(b).ready(function() {
    var d = c('meta[property="og:description"]').attr("content")
        ...
        : "",
      f = c('meta[property="og:image"]').attr("content")
    ...
    goodshare = {
      init: function(a, l) {
        ...
        if (null !== k.popup((link = k[e.type](e)))) return !1;
      },
      vk: function(a) {
        a = c.extend(
          { url: location.href, title: b.title, text: d, image: f },
          a
        );
        return (
      ...
      ok: function(a) {
        a = c.extend({ url: location.href, title: b.title }, a);
        return (
          "http://www.odnoklassniki.ru/dk?st.cmd=addShare&st.s=1&st.comments=" +
          encodeURIComponent(a.title) +
          "&st._surl=" +
          encodeURIComponent(a.url)
        );
      ...
      fb: function(a) {
        a = c.extend({ url: location.href, title: b.title }, a);
        return (
          "http://www.facebook.com/sharer.php?u=" + encodeURIComponent(a.url)
        );
      },
      lj: function(a) {
        a = c.extend({ url: location.href, title: b.title, text: d }, a);
        return (
          "http://livejournal.com/update.bml?subject=" +
          encodeURIComponent(a.title) +
          "&event=" +
          encodeURIComponent(
            '<a href="' + a.url + '">' + a.title + "</a> " + a.text
          )
        );
      },
      tw: function(a) {
      ...
      gp: function(a) {
        a = c.extend({ url: location.href }, a);
      ...
      en: function(a) {
        ...
        return (
          ...
          "&body=" +
          encodeURIComponent(
            a.text + '<br/><a href="' + a.url + '">' + a.title + "</a>"
          )
        );
      },
      di: function(a) {
      ...
      ra: function(a) {
        a = c.extend({ url: location.href }, a);
        return (
          "http://www.readability.com/save?url=" + encodeURIComponent(a.url)
        );
      },
      xi: function(a) {
        a = c.extend({ url: location.href }, a);
        return (
          "https://www.xing.com/spi/shares/new?url=" + encodeURIComponent(a.url)
        );
      },
      wp: function(a) {
        a = c.extend(
        ...
        return (
          "https://wordpress.com/wp-admin/press-this.php?u=" +
          encodeURIComponent(a.url) +
          "&t=" +
          encodeURIComponent(a.title) +
          "&s=" +
      ...
      vi: function(a) {
        a = c.extend({ url: location.href, title: b.title }, a);
        return (
          "viber://forward?text=" + encodeURIComponent(a.title + " " + a.url)
        );
      },
      wa: function(a) {
        a = c.extend({ url: location.href, title: b.title }, a);
        return (
          "whatsapp://send?text=" + encodeURIComponent(a.title + " " + a.url)
        );
      },
      ln: function(a) {
        a = c.extend({ url: location.href, title: b.title }, a);
    ...
    c.fn.getCount = function() {
      ...
      b('[data-counter="fb"]') &&
        c.getJSON(
          ...
          function(b) {
            b.shares === h
              ? c('[data-counter="fb"]').text("0")
              : c('[data-counter="fb"]').text(a(b.shares));
          }
        );
      b('[data-counter="ok"]') &&
        (c.getJSON(
          "https://connect.ok.ru/dk?st.cmd=extLike&uid=1&ref=" +
            encodeURIComponent(location.href) +
            "&callback=?",
          function(a) {}
        ),
        g.ODKL || (ODKL = {}),
        (ODKL.updateCount = function(b, e) {
          c('[data-counter="ok"]').text(a(e));
        }));
      b('[data-counter="gp"]') &&
        c.ajax({
          type: "POST",
      ...
      b('[data-counter="mr"]') &&
        c.getJSON(
          ...
          function(b) {
            ...
            c.isEmptyObject(b)
              ? c('[data-counter="mr"]').text("0")
              : c('[data-counter="mr"]').text(a(d));
          }
        );
      b('[data-counter="li"]') &&
        c.getJSON(
      ...
      b('[data-counter="tm"]') &&
        c.getJSON(
          "http://api.tumblr.com/v2/share/stats?url=" +
            encodeURIComponent(location.href) +
            "&callback=?",
          function(b) {
      ...
      b('[data-counter="rd"]') &&
        c.getJSON(
          ...
          function(b) {
            b = b.data.children;
            0 === b.length
              ? c('[data-counter="rd"]').text("0")
              : c('[data-counter="rd"]').text(a(b[0].data.score));
          }
        );
      b('[data-counter="su"]') &&
        c.getJSON(
          ...
          function(b) {
            ...
            b.result.views === h
              ? c('[data-counter="su"]').text("0")
              : c('[data-counter="su"]').text(a(b.result.views));
          }
        );
      b('[data-counter="po"]') &&
        c.getJSON(
          "http://query.yahooapis.com/v1/public/yql?q=" +
            encodeURIComponent(
              'select * from html where url="https://widgets.getpocket.com/v1/button?count=horizontal&url=' +
                location.href +
                '" and xpath="*"'
            ) +
            "&format=json&callback=?",
          function(b) {
            c('[data-counter="po"]').text(
              a(b.query.results.html.body.div.a.span.em.content)
            );
          }
        );
      b('[data-counter="bf"]') &&
      ...
      b('[data-counter="xi"]') &&
        c.getJSON(
          "http://query.yahooapis.com/v1/public/yql?q=" +
            ...
            "&format=json&callback=?",
          function(b) {
            c('[data-counter="xi"]').text(
              a(b.query.results.html.body.div[0].div[0].span.content)
            );
          }
        );
    };
